...
import "./HomePage.css"
import Slider from "./FotoSlider/Slider";
import SlideTitle from "./FotoSlider/SlideTitle";
import SlideImage from "./FotoSlider/SlideImage";
import Slide from "./FotoSlider/Slide";
import Arrows from "./FotoSlider/Arrows";
import SlidesList from "./FotoSlider/SlideList";

//СФОРМИРОВАТЬ КОНТЕКСТ СЛАЙДЕРА ВРУЧНУЮ ?ВНУТРИ КОМПОНЕНТ?
//НАЧАТЬ СО СЛАЙД ЛИСТА
